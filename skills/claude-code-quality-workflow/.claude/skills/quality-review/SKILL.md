...
`quality-workflow/scripts/prepare-review.sh initial`. Require `READY=1`, then read
...
only. Never edit or repair. If preparation fails, stop and report its evidence.
